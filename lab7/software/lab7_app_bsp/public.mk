...
# setting SOPC_SYSID_BASE_ADDRESS is 0x88
SOPC_SYSID_FLAG += --sidp=0x88
ELF_PATCH_FLAG  += --sidp 0x88

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1604992425
SOPC_SYSID_FLAG += --timestamp=1604992425
ELF_PATCH_FLAG  += --timestamp 1604992425
